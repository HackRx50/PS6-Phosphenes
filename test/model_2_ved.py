...
# Load the model
img_model = AutoModelForSeq2SeqLM.from_pretrained("black-forest-labs/FLUX.1-dev")
...
def generate_images_with_flux(prompts, output_folder):
    os.makedirs(output_folder, exist_ok=True)
    images = []

    for i, prompt in enumerate(prompts):
        image = pipe(prompt, guidance_scale=7.5, num_inference_steps=50).images[0]  # Adjust parameters as needed
...
images = generate_images_with_flux(prompts, output_folder)
